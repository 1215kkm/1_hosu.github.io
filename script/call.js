$(document).ready(function(){
    ...
    $('.teacher').css({position: 'fixed', width: '100%', height: '50px', background:'rgba(64,108,178,1)', zIndex: '777777', bottom: '0%', display: 'flex', justifyContent:' center', alignItems: 'center', color:' #fff'})
